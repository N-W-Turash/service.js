...
var Service = function () {
	...
	/*adds a string before or after each array element*/
	sProto.addString= function(arr,str,position){
	...
	sProto.arrayShuffle= function(arr){
        if(arguments.length!==1 || !sProto.typeCheck(arr,'object')){
			return;
		}
		else{
